(() => {
    ...
    if (menuBurger) menuBurger.addEventListener("click", (function(e) {
        menuBurger.classList.add("_icon-active");
        if (menuBody) menuBody.classList.add("_menu-active");
        if (bodyScroll) bodyScroll.classList.add("_active");
    }));
    const closeBurger = document.querySelector(".btn-close-menu");
    if (closeBurger) closeBurger.addEventListener("click", (function(e) {
        if (menuBurger) menuBurger.classList.remove("_icon-active");
        if (menuBody) menuBody.classList.remove("_menu-active");
        if (bodyScroll) bodyScroll.classList.remove("_active");
    }));
    const btnOpenTel = document.querySelector(".btn-open-tel");
    const openTel = document.querySelector(".list-dropdown-mb");
    if (btnOpenTel) btnOpenTel.addEventListener("click", (function(e) {
        btnOpenTel.classList.toggle("_active");
        if (openTel) openTel.classList.toggle("_active");
    }));
    const cards = document.querySelectorAll(".block-visible-cards");
    cards.forEach((card => {
        let btnVisibleCards = card.querySelector(".services-block__btn");
        let blockCards = card.querySelector(".services-block__cards");
        btnVisibleCards.addEventListener("click", (() => {
            btnVisibleCards.classList.toggle("_active");
            blockCards.classList.toggle("_active");
        }));
    }));
    window["FLS"] = true;
    isWebp();
